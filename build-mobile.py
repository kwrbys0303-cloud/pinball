#!/usr/bin/env python3
"""
fishing-v10.html から スマホ配布用の index.html を つくる。
...
SRC = pathlib.Path('fishing-v10.html')
...
<!--
  ...
  ============================================================
  中身は fishing-v10.html と 同じ。build-mobile.py で つくっています。
  直すときは fishing-v10.html を 直して、もう一度 build-mobile.py を
